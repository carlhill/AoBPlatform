...
/**
 * UsersView, seen as the platform rather than as the practice.
 *
...
import { UsersView } from '../../../../practice/users/UsersView';
import { PracticeOverride } from '../../../../practice/usePractice';
import { ViewOnly } from '../ViewOnly';

export default function ViewUsersViewPage({ params }: { params: Promise<{ practiceId: string }> }) {
