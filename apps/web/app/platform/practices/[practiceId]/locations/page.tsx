...
/**
 * LocationsView, seen as the platform rather than as the practice.
 *
...
import { LocationsView } from '../../../../practice/locations/LocationsView';
import { ViewOnly } from '../ViewOnly';

export default function ViewLocationsViewPage({ params }: { params: Promise<{ practiceId: string }> }) {
  const { practiceId } = use(params);
  return (
    <ViewOnly practiceId={practiceId}>
      <LocationsView practiceId={practiceId} />
    </ViewOnly>
  );
}
